...
import dev.alluvial.backport.iceberg.io.DataWriter;
import dev.alluvial.backport.iceberg.io.EqualityDeleteWriter;
import dev.alluvial.backport.iceberg.io.PositionDeleteWriter;
...
public class BackportORC {
    ...
    public static class WriteBuilder {
        ...
        public <D> FileAppender<D> build() {
            ...
            return new OrcFileAppender<>(schema,
                ...
                conf.getInt(VECTOR_ROW_BATCH_SIZE, DEFAULT_SIZE), metricsConfig);
        }
    }
    ...
    public static class ReadBuilder {
        ...
        private int recordsPerBatch = DEFAULT_SIZE;
